...
<body>
    ...
    <header>
        ...
        <div>
            ...
            <img class="ham image6"   alt="" >
            <img class="ham2 image7"   alt="">
        </div>
    </header>
    <div class="section1">
        <section>
            <div>
                Buy & sell crypto and gift cards with ease</div>
            <div>
                Enrich makes it easy to trade cryptocurrency and gift cards.<br>
                We are fast and reliable.
            </div>
            <div>
                <span class="arrow">&lrarr;</span>
                <span><a href="https://wa.me/2347061083954">Trade Now</a></span>
            </div>
            <div>
                <section class="msg">
                    <img  alt="msg" class="image8"><br><br>
                    24/7 customer support
                </section>
                <section class="msg">
                    <img  alt="flame" class="image9"><br><br>
                    Best available rates
                </section>
            </div>
        </section>
        <section class="lite">
            <img alt="lite" class="image10">
        </section>
    </div>
    <div class="section2">
        <div>
            Join the enrich trading academy for beginners,<br>
             active traders & investors
        </div>
        <div>
            The best way to learn crypto trading is at your finger tips, learn from a team of <br> expert traders
            with years of experience of profitable trading
        </div>
    </div>
    <div class="section3">
        <div>
    ...
    <div class="section4">
        <a href="academy.php" class="hover">Join us</a>
    </div>
    <div class="section5">
    ...
    <div class="section6">
        <section>
            <img  alt="enr" class="image11">
        </section>
        <section>
            <div class="enrich">
                <span>Why Enrich</span><br><br>
                we're here to cutdown the stress of trading your<br>
                crypto and giftcards.
            </div>
            <div>
                <div>
                    <img src="images/thunder.png" alt="thunder"><br><br>
                    Fast transactions
                </div>
                <div>
                    <img src="images/flame2.png" alt="flame2"><br><br>
                    Best available rates
                </div>
                <div>
                    <img src="images/msg2.png" alt="msg2"><br><br>
                    24/7 support
                </div>
                <div>
                    <img src="images/key.png" alt="key"><br><br>
                    Safe and secure
                </div>
            </div>
        </section>
    ...
    <div class="section7">
        <div class="span">Coin Market</div>
        <div>
            Who's gaining. Who's loosing. Stay Updated.
        </div>
    </div>
    <div class="section8">
        <div>
        ...
        <div>
            ...
            <div class="coins green show">+51%</div>
            <div class="coins show">1234567897665</div>
        </div>
        <div>
            <div class="coins logo">
            ...
            <div class="coins red show">+51%</div>
            <div class="coins show">1234567897665</div>
        </div>
        <div>
            <div class="coins logo">
    ...
    <footer>
        ...
        <div>
            <div> &copy;2022 Enrich crypto. All rights reserved</div>
        </div>
    </footer>
